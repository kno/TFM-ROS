...
if __name__ == '__main__':
    ...
    print os.getcwd()
    with open('/root/catkin_ws/src/drone_training/drone_training/configs/ddqn.json', 'r') as fp:
    ...
    if rospy.get_param("/save"):
        ...
        if not os.path.isdir(rospy.get_param("/save")):
            try:
                ...
                raise OSError("Cannot save agent to dir {} ()".format(rospy.get_param("/save")))
